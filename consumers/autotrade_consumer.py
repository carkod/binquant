...
class AutotradeConsumer(BinbotApi):
    ...
    def load_data_on_start(self):
        ...
        self.active_symbols = set({s["id"] for s in self.all_symbols if s["active"]}) - set(
    ...
    def process_autotrade_restrictions(self, result: str):
        ...
        """
        if self.autotrade_settings["autotrade"] and symbol in self.active_symbols and data.autotrade:
